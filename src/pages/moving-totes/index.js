...
const JSONbuildtime = ({data}) => {
  ...
  cat_link= `/${cat_link}/`
  // need to change
  let cat_text = menu.nestingBox.text
...
export const query = graphql`
  query{
    strapidata: allStrapiWebsiteseometa(filter: {domain: {name: {eq: "storagebinsell.com"}}, product_identify_cat: {eq: "nesting box"}}) {
      edges {
        node {
          id
          strapiId
