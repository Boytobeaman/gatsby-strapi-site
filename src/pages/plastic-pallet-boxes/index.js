...
import ThisCatDesc from '../../components/productDesc/PalletBox';
...
export const query = graphql`
  query{
    strapidata: allStrapiWebsiteseometa(filter: {domain: {name: {eq: "palletssupplier.com"}}, product_identify_cat: {eq: "pallet box"}}) {
      edges {
        node {
          id
          strapiId
    ...
    bannerDesktop: file(relativePath: {eq: "plastic-pallet-container-banner.jpg"}) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid
        }
    ...
    # need to change the file path
    bannerPhone: file(relativePath: {eq: "plastic-pallet-container-banner-phone.jpg"}) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid
        }
