          ...
          <section className='mb-5 border bg-light'>
            <div className="row">
              <div className="col-md-6">
                <video controls className='w-100 factory-video' poster={`${cdn_url}/static/plastic-pallet-manufacturer.jpg`}>
                  <source src={`${cdn_url}/static/video/automatic-plastic-pallet-manufacture.mp4`} type="video/mp4" />
